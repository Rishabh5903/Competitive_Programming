...
vl temp1,temp2;
FOR(i,0,r)temp1.pb(a[i]);FOR(i,l-1,n)temp2.pb(a[i]);sort(all(temp1));sort(all(temp2));
ll ans=accumulate(temp1.begin(),temp1.begin()+r-l+1,0LL);ans=min(ans,accumulate(temp2.begin(),temp2.begin()+r-l+1,0LL));
ce(ans);
